...
MODEL_ARGS_LLAMA3_8B_SPECUV2_TMP="\
--model_path=/gpfs/llama3/hf/8b_instruction_tuned
--model_arch=embedllama
--model_variant=llama3_8b
--ckpt_load_path=/gpfs/suneja/checkpoints/llama3-8b-specuv2-tmp
--ckpt_save_path=/gpfs/suneja/checkpoints/llama3-8b-specuv2-tmp
--logical_shards=768
--sharding_strategy=hsdp
--seq_length=8192
--batch_size=1
...
--model_arch=embedllama
--model_variant=7b
--ckpt_load_path=/gpfs/suneja/checkpoints/llama2-7b-specuv2-tmp
--ckpt_save_path=/gpfs/suneja/checkpoints/llama2-7b-specuv2-tmp
--logical_shards=768
--sharding_strategy=hsdp
--seq_length=4096
--batch_size=8
